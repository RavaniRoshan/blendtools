...
-- INSERT INTO public.scripts (name, description, category, code, author_id) VALUES
-- ('Batch Rename Objects', 'Rename multiple objects with patterns', 'Utility', 'import bpy\n\n# Your script code here', '00000000-0000-0000-0000-000000000000');

-- You can uncomment and modify the above when you have real user IDs
